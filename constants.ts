...
import { Message, SenderType, ChatParticipant } from './types';
...
export const initialMessages: Message[] = [
  {
    id: 'msg1',
    text: "I talked to her around 7:30 and she wasn't ok at all. She was smiling and talking to me as she does but yep something was bothering her at it's peak totally disturbed she was and I hope you know the reason well",
    timestamp: '22:38',
  ...
  {
    id: 'msg2',
    text: "So ya brother communicate and clear it out",
    timestamp: '22:39',
    sender: SenderType.OTHER,
    date: '2025-04-27'
  },
  {
    id: 'msg3',
    text: "Gm brother text me whenever u are free for 5 mins I have something important to talk",
    timestamp: '7:39 AM',
    sender: SenderType.OTHER,
    date: '2025-04-28'
  },
  ...
  {
    id: 'msg5',
    text: "Ok, sure. I will text you after 8:30.",
    timestamp: '8:25 AM',
  ...
  {
    id: 'msg6',
    text: "thank you for reaching out to me.<br>I'm here now.<br>Please tell me whatever you feel is important.<br>I will listen calmly.",
    timestamp: '09:05',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
  ...
  {
    id: 'msg8',
    text: "Thank you for telling me.<br>I feel terrible knowing that she's physically unwell because of me.<br>Honestly, I never kept her out of my heart or space intentionally.<br>It was my fear and overthinking that made me hide my struggles, not because I didn’t trust her, but because I thought I would become a burden on her, or that it will be just be too much for her to handle my negative emotions.<br>I realize now that she deserved to be there, beside me, and I made a huge mistake by not opening up.<br>I don’t want anything now except for her to get better, heal, and be happy, even if it takes time away from me.<br>Please tell her that I love her endlessly, and I am deeply sorry for everything.",
    timestamp: '09:14',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
  ...
  {
    id: 'msg10',
    text: "Sonali... there’s something more I want to say, because it matters a lot.<br>Even during those weak moments when I felt lost or upset, my feelings for her never changed.<br>I always trusted her. I always loved her with all my heart.<br>The emotions I wrote that time came from the weakest, darkest part of me, a part I never let win, a part I ignored because it only spread hate and fear.<br>Those weren’t my true feelings.<br>My real feelings, even in the middle of all the mess, were always the same:<br>Love, trust, and wanting her by my side.<br>I was closed off because I was upset and scared, not because I didn’t believe in her.<br>I regret hiding it, but I never regretted being with her, not even for a second.<br>I only wish I could have been stronger to show her that earlier.<br>Please tell her that.",
    timestamp: '09:21',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
  ...
  {
    id: 'msg15',
    text: "And yeah you guys are good and mature enough to handle yaar just sometimes ahh alright so take care of every small step from now onwards okk",
    timestamp: '09:48',
    sender: SenderType.OTHER,
    date: '2025-04-28'
  },
  {
    id: 'msg16',
    text: "Thank you for everything, Sonali. Your advice means a lot to me, and I’ll try to keep it in mind moving forward. I understand now that some things are out of our control and we just have to trust the process. I’ll focus on taking things small step at a time and not pressure myself or anyone else too much. I’m grateful for your support, and I’ll make sure to handle things carefully from now on. Take care as well, and thanks again for always being there for her.",
    timestamp: '09:50',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
  ...
  {
    id: 'msg18',
    text: "[I basically asked her if I can call for 5-10 mins and have a short talk and ask few things. If call isn't possible then download signal app or we can continue in whatsapp without any problem also.]",
    timestamp: '18:56',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
  {
    id: 'msg19',
    text: "I can't actually download anything till 3-4 days if you have anything to talk ,you can call me freely bro",
    timestamp: '18:55', // Note: This timestamp is earlier than the previous 'sent' message. Assuming chronological order is still by array position for display.
    sender: SenderType.OTHER,
    date: '2025-04-28'
  },
  {
  ...
  {
    id: 'msg21',
    text: "Thanks a lot for your permission. That would definitely work. I will call a bit later. Thank you again.",
    timestamp: '18:56',
    sender: SenderType.ME,
    date: '2025-04-28'
  },
